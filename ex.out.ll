...
L3:  ;
    ...
    br label %L4
L4:  ;
    %r37 = phi i32 [%r10,%L3],[%r19,%L5]
    %r13 = icmp slt i32 %r37,%r2
...
L6:  ;
    ...
    br label %L7
L7:  ;
    %r38 = phi i32 [%r23,%L6],[%r32,%L8]
    %r36 = phi i32 [%r8,%L6],[%r29,%L8]
    %r26 = icmp slt i32 %r38,%r22
    br i1 %r26, label %L8, label %L9
L8:  ;
    %r28 = call i32 @getint()
    %r29 = call i32 @delete(i32 %r36,i32 %r28)
    %r31 = add i32 1,0
    %r32 = add i32 %r38,%r31
    br label %L7
L9:  ;
    call void @inorder(i32 %r36)
    %r34 = load i32, ptr @LF
